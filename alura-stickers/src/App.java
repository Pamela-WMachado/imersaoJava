...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		//criar uma requisiçao passando o endereço da URI
		...
		//2 parsear os dados => filtrar os dados que nos interessam (titulo, poster e classificação)
		//criamos uma lista, que vai mapear os dados de uma chave do tipo String e o valor associado a essa chave tbm é String
